...
open class MarqueeLabel: UILabel, CAAnimationDelegate {
    ...
    */
    ...
    //for some reason these don't work on mac, but it's ok fuck interface builder anyways
    ...
    private func timingFunctionForAnimationCurve(_ curve: UIView.AnimationCurve) -> CAMediaTimingFunction {
        ...
        switch curve {
        case .easeIn:
            timingFunction = CAMediaTimingFunctionName.easeIn as CAMediaTimingFunctionName
        case .easeInOut:
            timingFunction = CAMediaTimingFunctionName.easeInEaseOut as CAMediaTimingFunctionName
        case .easeOut:
            timingFunction = CAMediaTimingFunctionName.easeOut as CAMediaTimingFunctionName
        default:
            timingFunction = CAMediaTimingFunctionName.linear as CAMediaTimingFunctionName
        }
        
        return CAMediaTimingFunction(name: timingFunction!) //return CAMediaTimingFunction(name: timingFunction! as String)
    }
